...
use Local\Core\Assistant\Iblock\ElementProperty;
use Local\Core\Model\Bitrix\ElementPropertyTable;
    ...
    protected function fillResult()
    {
        ...
        try {
            ...
            if (!empty($arResult['ITEMS'])) {
                $rsElemMainPhotos = ElementPropertyTable::getList(
                    [
                        'filter' => [
                            'IBLOCK_ELEMENT_ID' => array_keys($arResult['ITEMS']),
                            'IBLOCK_PROPERTY_ID' => ElementProperty::getIdByCode(
