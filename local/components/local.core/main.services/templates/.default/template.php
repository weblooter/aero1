...
<? if (!empty($arResult['ITEMS'])): ?>
    <section class="services container">
        <div class="title-preview post-up"><? $APPLICATION->IncludeFile('include/main-services-title.php', false, ['MODE' => 'text']) ?></div>
        <div class="h2 post-up"><? $APPLICATION->IncludeFile('include/main-services-text.php', false, ['MODE' => 'text']) ?></div>
