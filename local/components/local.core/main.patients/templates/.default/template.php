    ...
    <section class="infoMedia container post-up">
        <div class="row row-f reviews">
            <div class="col-xs-12 col-sm-6 reviews__text post-left">
                <div class="title-preview"><? $APPLICATION->IncludeFile('include/main-patients-title.php', false, ['MODE' => 'text']) ?></div>
                <div class="h2"><? $APPLICATION->IncludeFile('include/main-patients-h2.php', false, ['MODE' => 'text']) ?></div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6 infoMedia__item post-right">
                ...
                <p><? $APPLICATION->IncludeFile('include/main-patients-col2-text.php', false, ['MODE' => 'text']) ?></p>
