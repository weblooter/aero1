...
if( $obRequest->getPost('WEBLOOTER_FOOTER_INC_SAVE') === 'Y' && check_bitrix_sessid() )
{
    ...
    \Bitrix\Main\Application::getInstance()->getContext()->getResponse()->addHeader('Location', $obRequest->getRequestUri());
}
    ...
    <div class="bx-gadgets-content-padding-rl adm-workarea">
        <form action="" method="post">
            ...
            <table class="bx-gadgets-info-site-table">
                <tr>
                    <td>
                        <textarea name="WEBLOOTER_FOOTER_INC_TEXT" style="width: 100%; min-height: 350px; resize: vertical;"><?include $_SERVER['DOCUMENT_ROOT'].'/.footer-inc.text'?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
