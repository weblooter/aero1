...
class Version20200424205009 extends Version
{
    protected $description = "ИБ \"Памятка\"";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()
            ->saveIblock(array(
                'IBLOCK_TYPE_ID' => 'main_ved',
                'LID' =>
                    array(
                        0 => 's1',
                    ),
                'CODE' => 'useful_pamyatka',
                'NAME' => 'Полезно: Памятка',
                'ACTIVE' => 'Y',
                'SORT' => '500',
                'LIST_PAGE_URL' => '/poleznoe/pamyatka/',
                'DETAIL_PAGE_URL' => '/poleznoe/pamyatka/#ELEMENT_CODE#/',
                'SECTION_PAGE_URL' => '/poleznoe/pamyatka/',
                'CANONICAL_PAGE_URL' => '',
                'PICTURE' => null,
                'DESCRIPTION' => '',
        ...
        $helper->Iblock()
            ->saveIblockFields($iblockId, array(
                'IBLOCK_SECTION' =>
                    array(
        ...
        $helper->Iblock()
            ->saveGroupPermissions($iblockId, array(
                'administrators' => 'X',
                'everyone' => 'X',
            ));
        $helper->UserOptions()
