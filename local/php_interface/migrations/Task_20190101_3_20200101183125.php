...
class Task_20190101_3_20200101183125 extends Version
{
    protected $description = "Добавляем ИБ СМИ";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()
            ->saveIblock(array(
                ...
                'ACTIVE' => 'Y',
                'SORT' => '500',
                'LIST_PAGE_URL' => '/poleznoe/smi/',
                'DETAIL_PAGE_URL' => '/poleznoe/smi/#ELEMENT_CODE#/',
                'SECTION_PAGE_URL' => '/poleznoe/smi/',
                'CANONICAL_PAGE_URL' => '',
                'PICTURE' => null,
                'DESCRIPTION' => '',
