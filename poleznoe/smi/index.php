...
$APPLICATION->SetPageProperty("h1", "СМИ");
$APPLICATION->SetPageProperty("pre-h1", "СМИ");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"IBLOCK_ID" => \Local\Core\Assistant\Iblock::getIdByCode('main_ved','useful_smi'),
