...
$APPLICATION->SetPageProperty("pre-h1", "Фото работ");
$APPLICATION->SetPageProperty("h1", "Фото работ до и после");
$APPLICATION->SetTitle("Фото работ");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"LIST_PROPERTY_CODE" => array("IS_18",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "6000",
