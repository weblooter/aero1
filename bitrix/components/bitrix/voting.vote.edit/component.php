...
else if (!empty($arParams["INPUT_VALUE"]))
{
	...
	if (!empty($arResult["VOTES"]))
	{
		...
		{
			if (
				$arResult["VOTES"][$res["VOTE_ID"]]["QUESTIONS"][$res["QUESTION_ID"]]["FIELD_TYPE"] == \Bitrix\Vote\QuestionTypes::CHECKBOX ||
				$arResult["VOTES"][$res["VOTE_ID"]]["QUESTIONS"][$res["QUESTION_ID"]]["FIELD_TYPE"] == \Bitrix\Vote\QuestionTypes::MULTISELECT ||
				($arResult["VOTES"][$res["VOTE_ID"]]["QUESTIONS"][$res["QUESTION_ID"]]["FIELD_TYPE"] == \Bitrix\Vote\QuestionTypes::COMPATIBILITY &&
					($res["FIELD_TYPE"] == \Bitrix\Vote\AnswerTypes::CHECKBOX || $res["FIELD_TYPE"] == \Bitrix\Vote\AnswerTypes::MULTISELECT)
				)
			)
			{
