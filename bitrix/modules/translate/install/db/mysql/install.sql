...
(
	...
	LEFT_MARGIN int(18) null default null,
	RIGHT_MARGIN int(18) null default null,
	MODULE_ID varchar(50) null default null,
	ASSIGNMENT varchar(50) null default null,

	PRIMARY KEY (ID),
	UNIQUE KEY IX_TRNSL_PTH_NAME (PARENT_ID, NAME),
	KEY IX_TRNSL_PTH_LEFT (LEFT_MARGIN, RIGHT_MARGIN) USING BTREE,
	KEY IX_TRNSL_PTH_RIGHT (RIGHT_MARGIN, LEFT_MARGIN) USING BTREE,
