...
if (!$request->offsetExists('landing_mode')):
	...
	<div class="landing-ui-panel landing-ui-panel-top">
		...
		<div class="landing-ui-panel-top-menu" id="landing-panel-settings">
			...
			<a href="<?= $urls['preview']->getUri();?>" id="landing-urls-preview" class="ui-btn ui-btn-light-border landing-ui-panel-top-menu-link landing-btn-menu" target="_blank">
			...
			<div class="ui-btn-split ui-btn-primary landing-btn-menu<?= !$arResult['CAN_PUBLIC_SITE'] ? ' ui-btn-disabled' : '';?>">
				<a href="<?= ($arParams['TYPE'] == 'STORE') ? $urls['publicationAll']->getUri() : $urls['publication']->getUri();?>" id="landing-publication" class="ui-btn-main" target="_blank">
